...
implicit none
    ...
    real,parameter::T=0.0000000003!temperature prameter
    ...
    real::R
    real::tx,ty,phi_new,beta,dtx,dty ,d_phio,d_dphi!program write_time variables
    d_phio = 0.0
